...
#Ввод констант для расчёта урожайности
...
#Коэффициент для эскпозиции склона - считаем, что все поля идеально ровные
y1=1.0;
...
#Скачивание данных и создание из них датафрейма с информацией по 15 станциям 
...
#Подсчёт средних активных температур по месяцам за нужный период времени
